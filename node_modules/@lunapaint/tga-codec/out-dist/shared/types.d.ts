export { BitDepth, ColorMapType, IDecodedTga, IDecodeTgaOptions, IEncodeTgaOptions, IImage32, ImageType, ITgaDetails, ITgaFooter, ITgaHeader, ScreenOrigin, } from '../../typings/api.js';
import { BitDepth, DecodeWarning, EncodeWarning, IDecodeTgaOptions, IDeveloperDirectoryEntry, IEncodeTgaOptions, IExtensionArea, IImage32, ImageType, ITgaFooter, ITgaHeader } from '../../typings/api.js';
...
export declare type IWritePixelDelegate = (stream: IByteStream, imageData: Uint8Array, imageOffset: number) => void;
